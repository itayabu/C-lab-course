...
/*
 * generic object struct, hold a key and can be part of linked list
 *
 */
...
/*
 * generic table struct to implement hash table.
 */
typedef struct Table
{
	//dim- dimensions the table been multiplied by.
	int arrSize, dim;

	// functions to be added
	ComparisonFcn compFun;
	HashFcn hashFun;
	PrintFcn printFun;

	//a pointer to an array
	ObjectP* tableOfObjects;
